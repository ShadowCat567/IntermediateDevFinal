//PLACEHOLDER CAMERA FROM https://github.com/minhhh/unity-camera-follow-2d
//NOT DESIGNED FOR FINAL GAMEPLAY 
...
namespace CustomCamera
{
    ...
    public class FollowPlayerCam : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            deltaCenterVec = cam.ViewportToWorldPoint(new Vector3(0.5f, 0.5f, 0))
                - cam.ViewportToWorldPoint(new Vector3(cameraCenterX, cameraCenterY, 0));
        ...
        void LateUpdate()
        {
            if (target)
            {
                Vector3 delta = target.position - cam.ViewportToWorldPoint(new Vector3(cameraCenterX, cameraCenterY, 0));
